  ...
  void handleGesture(int direction) {
    ...
    */
    ...
    if (direction == 0) {
      ...
      // Xu ly truot tu trai sang phai
    } else if (direction == 2) {

      // Xu ly truot tu phai sang trai
    } else if (direction == 3) {
      setState(() {
        grid = flipGrid(grid);
        flipped = true;
    ...
    // Kiem tra neu van dang choi va chua thua
    if (played) {
      print('playing');
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      // Phat hien ngon tay truot len hoac xuong
                      ...
                      // Phat hien ngon tay truot sang trai hoac phai
